...
import { ConstantInitialVoiceCreditProxy, FreeForAllGatekeeper, MockVerifier, PollFactory, SignUpToken, SignUpTokenGatekeeper, Verifier, VkRegistry, PollFactory__factory as PollFactoryFactory, GitcoinPassportGatekeeper, SemaphoreGatekeeper, AnonAadhaarGatekeeper } from "../typechain-types";
/**
 ...
 */
export declare const deployAnonAadhaarGatekeeper: (verifierAddress: string, proofValidTime: number, signer?: Signer, quiet?: boolean) => Promise<AnonAadhaarGatekeeper>;
/**
