...
class Prover {
     ...
     */
    async submitResults(tallyData, recipients) {
        ...
        const tallyResultProofs = partialResults.map((_, index) => (0, maci_crypto_1.genTreeProof)(index, tallyResults, Number(treeDepths.voteOptionTreeDepth)));
