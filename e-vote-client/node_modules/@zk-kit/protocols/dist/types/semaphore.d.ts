...
export default class Semaphore {
     ...
     */
    static genWitness(identityTrapdoor: StrBigInt, identityNullifier: StrBigInt, merkleProof: MerkleProof, externalNullifier: StrBigInt, signal: string): SemaphoreWitness;
    /**
     ...
     */
    static packToSolidityProof(proof: Proof): SemaphoreSolidityProof;
}
