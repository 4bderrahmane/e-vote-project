 ...
 */
function generateMerkleTree(depth, zeroValue, leaves) {
    var tree = new incrementalMerkleTree.IncrementalMerkleTree(circomlibjs.poseidon, depth, zeroValue, 2);
 ...
 */
function generateMerkleProof(depth, zeroValue, leaves, leaf) {
    if (leaf === zeroValue)
        throw new Error("Can't generate a proof for a zero leaf");
    var tree = generateMerkleTree(depth, zeroValue, leaves);
...
var RLN = /** @class */ (function () {
     ...
     */
    RLN.genSignalHash = function (signal) {
...
var Semaphore = /** @class */ (function () {
     ...
     */
    Semaphore.genWitness = function (identityTrapdoor, identityNullifier, merkleProof, externalNullifier, signal) {
        return {
     ...
     * @returns The signal hash.
     */
    Semaphore.genSignalHash = function (signal) {
     ...
     */
    /* istanbul ignore next */
    Semaphore.packToSolidityProof = function (proof) {
        return [
            proof.pi_a[0],
            proof.pi_a[1],
            proof.pi_b[0][1],
