...
contract ElectionFactory {
    ...
    function createElection(bytes16 uuid, uint256 endTime, bytes32 encryptionPublicKey)
        external
        returns (address election)
    {
        ...
        emit ElectionDeployed(uuid, externalNullifier_, msg.sender, election, endTime);
    }
