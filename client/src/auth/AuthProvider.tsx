...
import {attachDevTokenLogger, consoleLogKeycloakObject, logTokenInfo} from "./devTokenDEBUG";
    ...
    useEffect(() => {
        ...
        keycloak
            ...
            .then((authenticated) => {
                ...
                if (import.meta.env.DEV) logTokenInfo(keycloak.idToken, "ID Token");
                if (import.meta.env.DEV) logTokenInfo(keycloak.refreshToken, "Refresh Token");
                if (import.meta.env.DEV) consoleLogKeycloakObject(keycloak);
